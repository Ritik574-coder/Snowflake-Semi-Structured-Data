...
-- querying customers reviews in products table 
SELECT 
    product_id,
...
-- querying suppliers info in products table 
SELECT 
...
-- querying specifications info in products table 
SELECT 
